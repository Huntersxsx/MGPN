...
if __name__ == '__main__':
    ...
    def network(sample):
        ...
        # prediction, map_mask, coarse_score = model(textual_input, textual_mask, visual_input)
        # loss_value, joint_prob = getattr(loss, config.LOSS1.NAME)(prediction, map_mask, map_gt, coarse_score, config.LOSS1.PARAMS)
