...
config.MGPN = edict()
config.MGPN.COARSE_GRAINED_ENCODER = edict()
config.MGPN.COARSE_GRAINED_ENCODER.NAME = ''
config.MGPN.COARSE_GRAINED_ENCODER.PARAMS = None
config.MGPN.CHOICE_GENERATOR = edict()
config.MGPN.CHOICE_GENERATOR.NAME = ''
config.MGPN.CHOICE_GENERATOR.PARAMS = None
config.MGPN.FINE_GRAINED_ENCODER = edict()
config.MGPN.FINE_GRAINED_ENCODER.NAME = ''
config.MGPN.FINE_GRAINED_ENCODER.PARAMS = None
config.MGPN.COATTENTION_MODULE = edict()
config.MGPN.COATTENTION_MODULE.NAME = ''
config.MGPN.COATTENTION_MODULE.PARAMS = None
config.MGPN.CONDITIONED_INTERACTION_MODULE = edict()
config.MGPN.CONDITIONED_INTERACTION_MODULE.NAME = ''
config.MGPN.CONDITIONED_INTERACTION_MODULE.PARAMS = None
config.MGPN.CHOICE_COMPARISON_MODULE = edict()
config.MGPN.CHOICE_COMPARISON_MODULE.NAME = ''
config.MGPN.CHOICE_COMPARISON_MODULE.PARAMS = None
config.MGPN.PRED_INPUT_SIZE = 512
